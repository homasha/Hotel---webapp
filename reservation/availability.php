				...
				<div class="col-md-4">
					<div class="hotel-content">
						...
						<div class="registrationForm">
							<h3><a href="#">Rejestracja</a></h3>
							<form class="" action="../index.php" method="post">
                <input type="text" name="name" value="Podaj imię">
                <input type="text" name="lastName" value="Podaj nazwisko">
                <input type="email" name="email" value="Podaj e-mail" required>
                <input type="text" name="phone" value="Podaj nr telefonu">
