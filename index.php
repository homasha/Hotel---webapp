...
<body>
					...
					<form action="hotel.php" method = "POST">
					  <div class="a-col alternate">
					      <div class="input-field">
					          ...
					          <input type="date" id="dateFrom" name="dateFrom" min="" value="<?php $today ?>" class="form-control" onchange="setCheckOutDate()" required />
					      </div>
					  </div>
					  <div class="a-col alternate">
					      <div class="input-field">
					  ...
					  <div class="a-col alternate">
					      <div class="input-field">
					          <label for="date-end">Guests</label>
					          <input type="number" name="guests" min="1" max="4" value="1" class="form-control" required />
					      </div>
					  </div>
					  <div class="a-col action">
					      <div class="input-field">
					          <br/><br/>
					          <input type = "submit" class="btn btn-primary btn-luxe-primary mt-1" value="Book" />
					      </div>
					  </div>
					</form>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="feature-full-2col">
					<div class="f-hotel">
						<div class="image" style="background-image: url(images/rooms/room-1.jpg);">
							<div class="descrip text-center">
	...
	{
		let x = document.getElementById('dateFrom').value;
		document.getElementById('dateTo').min = (x + 1);
	}
	</script>
</body>
</html>
